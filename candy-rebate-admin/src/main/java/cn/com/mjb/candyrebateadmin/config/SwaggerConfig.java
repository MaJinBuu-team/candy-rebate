...
public class SwaggerConfig {
    ...
    public static String CONTROLLER_URL = "cn.com.mjb.candyrebateadmin.controller";    //Swagger扫描的接口路径
    public static String SWAGGER_TITLE = "API文档-buu";                //Swagger接口文档标题
    public static String SWAGGER_DESCRIPTION = "返利项目文档";                //Swagger接口文档描述
